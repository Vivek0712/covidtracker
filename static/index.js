...
Highcharts.mapChart('container', {
    ...
    title: {
        text: 'India - Active COVID-19 Cases'
    },
...
var response = $.ajax({
  ...
  success:function(response){
	...
	if(response[statename].districtData !== null)
{   var datastring="";
    for (var district in response[statename].districtData){
		datastring+="<tr><td scope='row' class='info'>"+district+"</td><td id='active' class='danger'> "+response[statename].districtData[district].confirmed+"</td></tr>";
